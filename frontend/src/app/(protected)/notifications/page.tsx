...
const notificationColors: Record<string, string> = {
  ...
  message: 'bg-yellow-100 text-yellow-600 dark:bg-yellow-900/30 dark:text-yellow-400',
      ...
      {filteredNotifications.length === 0 ? (
        ...
        <div className="space-y-3">
          {filteredNotifications.map((notification) => {
            ...
            const colorClass = notificationColors[notification.category] || notificationColors.system;
