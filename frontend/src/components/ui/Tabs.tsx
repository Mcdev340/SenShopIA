...
export const TabsTrigger = ({
  ...
  const variantClasses = {
    default: cn(
      ...
      isActive && 'border-primary-600 text-primary-600 dark:border-primary-400 dark:text-primary-400'
    ),
    pills: cn(
    ...
    bordered: cn(
      ...
      isActive && 'bg-gray-50 dark:bg-gray-800 border-primary-600 dark:border-primary-400'
    ),
  };
