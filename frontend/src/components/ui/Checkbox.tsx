...
export const Checkbox = React.forwardRef<HTMLInputElement, CheckboxProps>(
  ({ className, label, error, success, indeterminate, disabled, checked, ...props }, ref) => {
    ...
    const checkboxClasses = cn(
      ...
      !error && !success && 'border-gray-300 dark:border-gray-600 focus:ring-primary-500',
      checked || indeterminate ? 'bg-primary-600 border-primary-600' : 'bg-white dark:bg-gray-900'
    );
