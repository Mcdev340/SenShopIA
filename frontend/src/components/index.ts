...
// Correction: un export ne peut utiliser qu'un seul alias; cette forme expose correctement le composant UI.
...
// Correction: l'alias de réexport est placé sur le nom exporté, conformément à la syntaxe TypeScript.
export { default as OrderSummaryCard } from "./orders/OrderSummary";
...
// ============================================
// Correction: l'alias de réexport est placé sur le nom exporté, conformément à la syntaxe TypeScript.
export { default as DashboardLayoutComponent } from "./dashboard/DashboardLayout";
