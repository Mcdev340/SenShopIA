      ...
      >
        <div className="flex gap-3">
          <div className="relative w-20 h-20 rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-700 flex-shrink-0">
            ...
            {isOnSale && (
              <Badge className="absolute top-1 left-1 text-xs bg-red-500 border-0">
                -{discountPercentage}%
              </Badge>
            )}
          </div>
        ...
        <div className="relative aspect-square overflow-hidden rounded-t-lg bg-gray-100 dark:bg-gray-700">
          ...
          {showStock && isOutOfStock && (
            <div className="absolute bottom-2 left-2 right-2">
              <Badge className="w-full justify-center bg-red-500/90 text-white border-0 shadow-lg py-1">
                Rupture de stock
              </Badge>
            </div>
          )}
          {showStock && isLowStock && !isOutOfStock && (
            <div className="absolute bottom-2 left-2 right-2">
              <Badge className="w-full justify-center bg-orange-500/90 text-white border-0 shadow-lg py-1">
