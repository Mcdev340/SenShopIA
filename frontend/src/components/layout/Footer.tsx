...
export default function Footer({
  ...
  const socialLinks = [
    ...
    { icon: MapPin, href: "https://instagram.com", label: "Instagram" },
    { icon: Shield, href: "https://linkedin.com", label: "LinkedIn" },
    { icon: Truck, href: "https://youtube.com", label: "YouTube" },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Plateforme intelligente qui simplifie les achats internationaux au
