    ...
    (set, get) => ({
      ...
      requestPasswordReset: async (email: string) => {
        ...
        try {
          ...
          const message =
            error instanceof ApiError ? error.message : "Erreur de demande";
          set({
            error: message,
            loading: false,
            status: "error",
      ...
      resendVerificationEmail: async (email: string) => {
        ...
        try {
          ...
          const message =
            error instanceof ApiError ? error.message : "Erreur d'envoi";
          set({
            error: message,
            loading: false,
            status: "error",
      ...
      createAddress: async (
        ...
        try {
          ...
          const message =
            error instanceof ApiError ? error.message : "Erreur de création";
          set({
            error: message,
            loading: false,
            status: "error",
 ...
 */
export const useUserActivities = (params?: {
  page?: number;
  limit?: number;
  type?: string;
}) => {
